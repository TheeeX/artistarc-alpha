          ...
          <div class='title'>
            ...
            <a class='minimize' href='page-profile.html#'>
              ...
              <ul class='tabs'>
                ...
                <li class='tab col s3'><a href='#test2'>Work</a></li>
                ...
                <div id='test3' class='col s12'>
                      ...
                      <!--  Pie Chart  -->
                        <div class='col s12 l6'>
                          ...
                          <div class='title'>
                            <h5>Pie Chart</h5>
                            <a class='close' href='charts-nvd3.html#'>
                            <i class='mdi-content-clear'></i>
                            </a>
                            <a class='minimize' href='charts-nvd3.html#'>
                            <i class='mdi-navigation-expand-less'></i>
                            </a>
                          </div>
                          <div class='content'>
                            <div id='chart4' style='height: 251px;'></div>
                          </div>
                          </div>
                        </div>
                      <!--  /Pie Chart  -->
